...
class LoggingModelAdmin(admin.ModelAdmin):
    ...
    list_display = ("level", "user", "ip", "path", "method", "text", "created")
    list_display_links = (
        "user",
        "ip",
        "path",
    ...
    list_editable = ("level",)
    list_filter = ("level", "user", "ip", "path", "method", "text", "created")
    fieldsets = (
        (
            "Основное",
            {
    ...
    search_fields = ["level", "user", "ip", "path", "method", "text", "created"]
